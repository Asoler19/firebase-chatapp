// Initialize Firebase
var config = {
    apiKey: "AIzaSyDyXVUlVg5JEg0UHOG6u8hFonuNRtdyg9Q",
    authDomain: "fir-chat-b236d.firebaseapp.com",
    databaseURL: "https://fir-chat-b236d.firebaseio.com",
    projectId: "fir-chat-b236d",
    storageBucket: "fir-chat-b236d.appspot.com",
    messagingSenderId: "592575709547"
  };
  ...
  var login = () => {
    firebase.auth().signInWithPopup(provider).then(function(result) {
      // Facebook Access Token to access the Facebook API.
